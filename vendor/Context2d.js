...
Context2d.prototype =
{
   ...
   */
  roundedRect: function(x, y, bottom, right, radius)
  {
    this.beginPath();
    ...
    this.arcTo(right, y, right, bottom, radius);

    this.moveTo(right, y + radius);
    this.lineTo(right, bottom - radius);

    this.arcTo(right, bottom, x, bottom, radius);

    this.moveTo(right - radius, bottom);
    this.lineTo(x + radius, bottom);

    this.arcTo(x, bottom, x, y, radius);

    this.moveTo(x, bottom - radius);
    this.lineTo(x, y + radius);

    this.arcTo(x, y, right, y, radius);
  },
